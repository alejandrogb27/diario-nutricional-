...
// El panel se ancla por defecto al borde derecho del botón (right: 0 en CSS).
// En pantallas angostas eso puede hacer que se salga por la izquierda del
// viewport y quede cortado. Acá medimos su posición real ya renderizada y lo
// reubicamos dentro de los márgenes de la pantalla si hace falta.
function posicionarPanelTema() {
